...
;(async () => {
  ...
  await container.resolve<WebsocketProviderWrapper>('websocketProviderWrapper').attach()
  await container.resolve<WsRelayerServer>('wsRelayerServer').attach()
  await container.resolve<V1OwnController>('v1OwnController').attach()
  await container.resolve<V2RelayerController>('v2RelayerController').attach()
