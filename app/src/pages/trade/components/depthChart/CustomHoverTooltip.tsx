// https://github.com/rrag/react-stockcharts/blob/a2e4ea74058c22d8ba00a5bf905bff40069bdb92/src/lib/tooltip/HoverTooltip.js
...
class CustomHoverTooltip extends Component<any> {
  context: any
  ...
  renderSVG (moreProps) {
    const pointer = helper(this.props, moreProps) as any
...
(CustomHoverTooltip as any).defaultProps = {
  // bgwidth: 150,
  // bgheight: 50,
...
function helper (props, moreProps, ctx = undefined) {
  ...
  // TODO remove Hack
  if (currentItem.showTooltip === false) return
